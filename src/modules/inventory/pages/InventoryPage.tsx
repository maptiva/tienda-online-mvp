...
import { useProducts, type UseProductsReturn } from '../../../hooks/useProducts';
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4 md:p-12 bg-gray-50/30 rounded-3xl border-2 border-dashed border-gray-200 animate-fade-in">
        ...
        <div className="relative text-center max-w-2xl">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4">
            <a
              href={`https://wa.me/5493456533273?text=${encodeURIComponent('Hola! Me interesa activar el Motor de Stock Inteligente en mi tienda Clicando. ¿Me das más info?')}`}
              target="_blank"
