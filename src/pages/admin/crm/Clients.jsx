...
const Clients = () => {
    ...
    return (
        <div className="p-4 md:p-6 max-w-7xl mx-auto flex flex-col h-full">
            <div className="mb-6">
                <h1 className="text-2xl md:text-4xl font-black text-gray-800 tracking-tighter italic border-b border-gray-100 pb-4">Gestión Clientes Maestro</h1>
                <p className="text-gray-400 text-[10px] md:text-xs mt-2 uppercase tracking-[0.2em] font-black opacity-50">Consola de Control Comercial</p>
            </div>
            ...
            {/* Contenedor Maestro Estilo Admin */}
            <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 flex flex-col overflow-hidden flex-1 min-h-[500px]">
                ...
                <div className="md:hidden overflow-y-auto px-4 py-6 space-y-4 max-h-[600px] custom-scrollbar bg-gray-50/30 border-t border-gray-100">
                    {filteredClients.length === 0 ? (
